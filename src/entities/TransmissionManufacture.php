...
/**
 * This is the model class for table "{{%dk_vehicle_transmission_manufactures}}".
 *
 * @property int $id
 ...
 */
class TransmissionManufacture extends ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return '{{%dk_vehicle_transmission_manufactures}}';
    }
